      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-[#444] space-y-6 text-lg leading-relaxed">
            <p>Eating disorders involve complex relationships with food, body, and control, and often carry deep emotional weight. Support should always be careful and non-judgmental.</p>
            <p>Ketamine therapy may be explored as part of a broader support plan for some individuals, helping address underlying emotional patterns. It is sometimes considered when traditional approaches have not brought sufficient relief, and some people experience shifts more quickly than expected.</p>
            <p>At Rewired Ketamine in Aventura, we approach this work with sensitivity and collaboration. Fully guided sessions are available for those in Miami and South Florida seeking thoughtful, supportive care.</p>
          </div>
        </div>
      </section>
