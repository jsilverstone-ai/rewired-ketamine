    ...
    <div className="md:hidden bg-[#0B1D36] border-t border-white/10">
      ...
      <section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Palliative & Compassion Care</h1>
          <p className="text-xl text-white/85 max-w-2xl mx-auto mb-8">Fully guided ketamine support in a palliative and compassion-care context.</p>
