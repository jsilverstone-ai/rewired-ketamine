      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-[#444] space-y-6 text-lg leading-relaxed">
            <p>Obsessive-compulsive patterns can create intense loops of thought and behavior that feel difficult to interrupt, often consuming time and emotional energy.</p>
            <p>Ketamine therapy may help some people with OCD by supporting greater mental flexibility and reducing the grip of rigid thought cycles. Results are often felt more quickly than with traditional approaches, and it can be an option when other treatments have not been enough.</p>
            <p>Our Aventura clinic offers fully guided ketamine sessions for OCD-related concerns. We serve patients in Miami, Fort Lauderdale, and throughout South Florida.</p>
          </div>
        </div>
      </section>
