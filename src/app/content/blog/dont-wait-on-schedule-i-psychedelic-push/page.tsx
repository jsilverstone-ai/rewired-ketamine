...
export default function DontWaitOnScheduleIPsychedelicPushPage() {
    ...
    <main className="min-h-screen bg-[#F8F5F0] text-[#1a1a1a]">
      ...
      <section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Can Ketamine Therapy Help with PTSD?</h1>
...
<section className="py-20 px-6">
  <div className="max-w-3xl mx-auto">
    <div className="text-[#444] space-y-6 text-lg leading-relaxed">
      <p>
        Psychedelic medicine is back in the headlines after the Trump administration moved to accelerate research and access for compounds such as ibogaine and psilocybin. An FDA public meeting on safety and access standards is the latest step.{" "}
        <a href="https://www.reuters.com/business/healthcare-pharmaceuticals/what-know-about-psychedelic-therapies-cited-by-trump-2026-09-15/" target="_blank" rel="noopener noreferrer" className="text-[#C9A66B] hover:underline">Reuters summarized the landscape</a>.
      </p>
      <p>
        Most of these drugs are still Schedule I in the United States. That legal status gets the attention. It should not hide a simpler fact: one related treatment is already used in clinics, already studied at scale, and does not require Congress or the DEA to reschedule psilocybin first. Patients comparing{" "}
        <Link href="/" className="text-[#C9A66B] hover:underline">ketamine Miami</Link> and{" "}
        <Link href="/location" className="text-[#C9A66B] hover:underline">ketamine Aventura</Link> options can start there.
      </p>
    </div>

    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">The policy moment</h2>
    ...
    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">Where the evidence is strongest</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>
    ...
    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">How these treatments are supposed to work</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>
    ...
    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">What is actually closest to approval</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>
    ...
    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">The risks are not theoretical</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>
    ...
    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">You do not have to wait for rescheduling</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>
      ...
      <p>
        The research base is large compared with ibogaine or unapproved psilocybin. That does not make ketamine risk-free or a cure. It does mean the “nothing is available until Washington changes the schedules” story is incomplete.{" "}
        <Link href="/services" className="text-[#C9A66B] hover:underline">IV ketamine therapy</Link> and other modalities are offered at our locally owned Aventura clinic, serving Miami, North Miami, and South Florida. Fully guided sessions are available.
      </p>
    </div>

    <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">The practical takeaway</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>
    ...
    <div className="faq-list space-y-0">
      <div className="py-6 border-b border-[#e6e0d6]">
        <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Is psilocybin legal in Florida clinics right now?</h3>
        <p className="text-[#555] leading-relaxed">No. Classic psychedelics such as psilocybin and MDMA remain Schedule I in the United States. Clinic availability is not the same as trial research.</p>
      </div>
      <div className="py-6 border-b border-[#e6e0d6]">
        <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">How is ketamine different from those drugs?</h3>
        <p className="text-[#555] leading-relaxed">Ketamine is FDA-approved as an anesthetic and used off-label for depression in medical settings. Esketamine (Spravato) is FDA-approved for treatment-resistant depression. It is not a Schedule I psychedelic.</p>
      </div>
      <div className="py-6 border-b border-[#e6e0d6]">
        <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Do I have to wait for Washington to change the schedules?</h3>
        <p className="text-[#555] leading-relaxed">Not to discuss ketamine. Patients in Miami, Aventura, and North Miami can ask about current clinic options after a medical evaluation. Results vary.</p>
      </div>
      <div className="py-6">
        <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Where is Rewired Ketamine?</h3>
        <p className="text-[#555] leading-relaxed">Aventura, serving Miami and South Florida. Fully guided sessions are available. ¡Hablamos Español!</p>
      </div>
    </div>
  </div>
</section>
