      ...
      <section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/85 max-w-2xl mx-auto mb-8">
            Understanding who may benefit from ketamine therapy at our locally owned Aventura clinic.
          </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-[#444] space-y-6 text-lg leading-relaxed">
            <p>
              Mental health journeys are unique. While traditional approaches have helped many people, some continue looking for additional options that feel more aligned with their needs. Ketamine therapy is one approach that is receiving growing attention when delivered under professional medical supervision.
            </p>
            <p>
              At Rewired Ketamine, a locally owned clinic in Aventura, Florida, we offer fully guided sessions available as part of a personalized care plan. We serve patients from Miami, Fort Lauderdale, and across South Florida. ¡Hablamos Español!
            </p>
          </div>
          ...
          <div className="text-[#444] space-y-5 text-lg leading-relaxed">
            <p>
              Ketamine therapy is a medically supervised treatment that may be considered as part of a broader mental wellness plan. Rather than a one-size-fits-all approach, care is individualized and focuses on professional oversight, safety, and ongoing support.
            </p>
            <p>
          ...
          <div className="text-[#444] space-y-5 text-lg leading-relaxed">
            <p>
              Some individuals explore ketamine therapy because they want additional options beyond traditional approaches, prefer personalized care, or are seeking professional medical guidance as part of a more comprehensive wellness plan.
            </p>
            <p>
              A thorough evaluation with qualified providers is always the starting point. At our Aventura clinic, this conversation helps determine whether ketamine therapy may be an appropriate next step for each person.
            </p>
          </div>
          ...
          <div className="text-[#444] space-y-5 text-lg leading-relaxed">
            <p>
              A consultation typically includes a review of medical history, discussion of current concerns and previous experiences, and clarification of personal wellness goals. This process allows us to create a care plan that feels appropriate and supportive.
            </p>
            <p>
              As a locally owned practice serving South Florida, we take time to understand each patient’s unique situation before moving forward.
            </p>
          </div>
          ...
          <div className="text-[#444] space-y-5 text-lg leading-relaxed">
            <p>
              The first appointment is designed to provide clear information and open space for questions. We review health background, previous treatment experiences, and personal goals so that any recommendations feel collaborative and informed.
            </p>
            <p>
              Fully guided sessions are available for those who choose this level of support. Our focus remains on safety, comfort, and partnership throughout the process.
            </p>
          </div>

          <h2 className="text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">
            Building a longer-term wellness approach
          </h2>
          <div className="text-[#444] space-y-5 text-lg leading-relaxed">
            <p>
              Sustainable progress often includes professional care combined with supportive daily habits such as balanced nutrition, movement, quality sleep, and stress management. Ongoing communication with the care team helps adjust the plan as needs evolve.
            </p>
            <p>
              At Rewired Ketamine in Aventura, we support patients from Miami, Fort Lauderdale, and the greater South Florida area who are exploring thoughtful, clinically supervised options. We are locally owned and proud to offer care in both English and Spanish.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 border border-[#eee]">
              <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Who may be a good candidate for ketamine therapy?</h3>
              <p className="text-[#555] leading-relaxed">Individuals seeking personalized, medically supervised options may benefit from a professional evaluation to determine whether ketamine therapy is appropriate for their circumstances.</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-[#eee]">
              <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Do you offer fully guided sessions?</h3>
              <p className="text-[#555] leading-relaxed">Yes. Fully guided sessions are available at our Aventura clinic. Care is always tailored to the individual.</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-[#eee]">
              <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Is Rewired Ketamine a local clinic?</h3>
              <p className="text-[#555] leading-relaxed">Yes. We are a locally owned clinic based in Aventura, serving Miami, Fort Lauderdale, and South Florida. ¡Hablamos Español!</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-[#eee]">
              <h3 className="font-semibold text-[#0B1D36] text-lg mb-2">What happens in the first consultation?</h3>
              <p className="text-[#555] leading-relaxed">We review medical history, discuss goals and previous experiences, and answer questions so you can make an informed decision about next steps.</p>
            </div>
          </div>
        </div>
      </section>
