...
<section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
  <div className="max-w-4xl mx-auto text-center">
    ...
    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Is Ketamine Therapy Safe For Long-Term PTSD Management?</h1>
    <p className="text-xl text-white/85 max-w-2xl mx-auto mb-8">A careful, conservative look at ketamine therapy for PTSD and ongoing planning.</p>
...
<section className="py-20 px-6">
  <div className="max-w-3xl mx-auto">
    <div className="text-[#444] space-y-6 text-lg leading-relaxed">
      <p>Long-term ketamine safety is a fair question. The honest answer is that ketamine is not automatically a lifelong treatment, and it is not right for everyone. Decisions about ongoing care belong with a clinical team after evaluation and follow-up.</p>
      <p>See our <Link href="/treatments/ptsd" className="text-[#C9A66B] hover:underline">PTSD treatment page</Link> for condition-specific context.</p>
    </div>
    <h2 className="text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">What “safe” means in clinic</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>Safety includes screening, monitoring, individualized dosing, and time to recover. Fully guided sessions are available. We do not use ketamine as a plan designed to keep patients in treatment forever.</p>
    </div>
    <h2 className="text-2xl md:text-3xl font-bold text-[#0B1D36] mt-14 mb-5">PTSD care is broader than one medicine</h2>
    <div className="text-[#444] space-y-5 text-lg leading-relaxed">
      <p>Support may also include therapy, integration, and medical management. Some people notice changes more quickly than with traditional therapy; others need more time. Results vary.</p>
    </div>
    <h2 className="text-2xl md:text-3xl font-bold text-[#0B1D36] mt-16 mb-8">Frequently Asked Questions</h2>
    <div className="space-y-6">
      <div className="bg-white rounded-xl p-6 border border-[#eee]"><h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Is long-term ketamine automatically recommended for PTSD?</h3><p className="text-[#555] leading-relaxed">No. Plans are individualized and reviewed over time.</p></div>
      ...
      <div className="bg-white rounded-xl p-6 border border-[#eee]"><h3 className="font-semibold text-[#0B1D36] text-lg mb-2">Do you serve Miami?</h3><p className="text-[#555] leading-relaxed">Yes. Our ketamine clinic Miami patients visit is in Aventura. ¡Hablamos Español!</p></div>
    </div>
  </div>
</section>
