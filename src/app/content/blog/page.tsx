      ...
      <section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/85 max-w-2xl mx-auto mb-8">
            Thoughtful articles from the Rewired Ketamine team.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                ...
                <h2 className="text-xl font-bold text-[#0B1D36] mb-3">Who May Be a Good Candidate for Ketamine Therapy?</h2>
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                <p className="text-sm text-[#C9A66B] font-medium mb-2">Coming soon</p>
                <h2 className="text-xl font-bold text-[#0B1D36] mb-3">What Is Ketamine-Assisted Therapy?</h2>
            ...
            <article className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                <p className="text-sm text-[#C9A66B] font-medium mb-2">Coming soon</p>
                <h2 className="text-xl font-bold text-[#0B1D36] mb-3">How Neuroplasticity Supports Healing</h2>
