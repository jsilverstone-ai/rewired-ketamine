    ...
    <div className="md:hidden bg-[#0B1D36] border-t border-white/10">
      ...
      <section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Videos</h1>
          <p className="text-xl text-white/85 max-w-2xl mx-auto mb-8">
            Short videos and patient education from our Aventura clinic.
          </p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Video 1 – replace with real YouTube embed later */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold text-[#0B1D36] mb-2">Welcome to Rewired Ketamine</h2>
                <p className="text-[#555] text-sm leading-relaxed">A short introduction to our Aventura clinic and approach to care.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold text-[#0B1D36] mb-2">What to Expect in a Session</h2>
                <p className="text-[#555] text-sm leading-relaxed">A calm walkthrough of the guided ketamine experience.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold text-[#0B1D36] mb-2">Patient Education</h2>
                <p className="text-[#555] text-sm leading-relaxed">Helpful information about ketamine therapy and what patients often ask.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-[#eee]">
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold text-[#0B1D36] mb-2">Our Approach</h2>
                <p className="text-[#555] text-sm leading-relaxed">Learn more about how we support patients at Rewired Ketamine in Aventura.</p>
              </div>
            </div>
