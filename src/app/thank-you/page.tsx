    ...
    <main className="min-h-screen bg-[#F8F5F0] text-[#1a1a1a]">
      ...
      <section id="main-content" className="py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-white rounded-2xl shadow-sm border border-[#eee] p-10 md:p-14">
            <div className="w-16 h-16 bg-[#C9A66B]/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-[#C9A66B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
            </div>
            
            <h1 className="text-3xl md:text-4xl font-bold text-[#0B1D36] mb-4">
              Thank You
            </h1>
            ...
            <p className="text-[#666] mb-10">
              In the meantime, feel free to explore more about our services or call us directly.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                ...
                className="inline-block border-2 border-[#0B1D36] text-[#0B1D36] font-bold px-8 py-3 rounded-full hover:bg-[#0B1D36] hover:text-white transition"
              >
                Call (305) 676-6070
              </a>
            </div>
