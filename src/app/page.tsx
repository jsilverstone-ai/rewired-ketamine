...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#F8F5F0] text-[#1a1a1a]">
      ...
      {/* ===== HEADER - MUCH STRONGER BRANDING ===== */}
      <header className="bg-[#0B1D36] text-white sticky top-0 z-50 shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <a href="tel:3056766070" className="hidden md:block font-semibold hover:text-[#C9A66B] transition">
              305-676-6070
            </a>
            <a
              href="#contact"
              className="bg-[#C9A66B] text-[#0B1D36] text-sm font-bold px-6 py-3 rounded-full hover:bg-white transition"
            >
      ...
      <section className="pt-24 pb-28 md:pt-32 md:pb-36 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-[#444] max-w-3xl mx-auto mb-6 leading-relaxed">
