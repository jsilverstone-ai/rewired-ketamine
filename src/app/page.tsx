    ...
    <main className="min-h-screen bg-[#F8F5F0] text-[#1a1a1a]">
      ...
      <section id="contact" className="py-28 px-6 bg-[#0B1D36] text-white text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <a href="tel:+13056766070" className="inline-block bg-[#C9A66B] text-[#0B1D36] font-bold px-12 py-5 rounded-full text-lg hover:bg-white transition mb-12">
            Book Free Consultation
          </a>

          <div className="mt-12 flex flex-col items-center gap-6 text-white/90">
...
<div className="flex flex-col items-center text-center">
  ...
  <div className="flex gap-4 mb-6">
    ...
    {/* ... keep the other social icons the same ... */}
  </div>

  {/* LegitScript Badge - now local */}
  <a 
  ...
  >
    ...
    />
              ...
              >
                <img 
                  src="https://static.legitscript.com/seals/729458.png" 
                  alt="LegitScript Certified" 
                  width="160" 
                  height="80"
