...
export default function LocationPage() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F5F0] text-[#1a1a1a]">
      ...
      {/* MAIN NAVIGATION - temporary (will be updated site-wide next) */}
      <header className="bg-[#0B1D36] text-white sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          <nav className="hidden md:flex items-center gap-8 text-[15px] font-medium">
            ...
            <Link href="/location" className="text-[#C9A66B]">Location</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-[#0B1D36] border-t border-white/10">
            <nav className="flex flex-col px-6 py-4 space-y-4">
              ...
              <Link href="/location" className="text-[#C9A66B]" onClick={() => setIsMenuOpen(false)}>Location</Link>
      ...
      <section id="main-content" className="bg-[#0B1D36] text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/85 max-w-2xl mx-auto mb-8">
            A calm, private clinical space in the heart of Aventura — serving Miami, Fort Lauderdale, and South Florida.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="space-y-6 text-[#444] text-lg leading-relaxed">
                ...
                <div>
                  <h3 className="font-semibold text-[#0B1D36] mb-1">Serving</h3>
                  <p>Miami • Fort Lauderdale • Aventura • Miami-Dade • Broward • South Florida</p>
                </div>
              </div>
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                <a 
                  ...
                  className="inline-block bg-[#C9A66B] text-[#0B1D36] font-bold px-7 py-3 rounded-full hover:bg-[#0B1D36] hover:text-white transition"
                >
                  Get Directions
                </a>
                <Link 
                  href="/#contact" 
                  className="inline-block border-2 border-[#0B1D36] text-[#0B1D36] font-bold px-7 py-3 rounded-full hover:bg-[#0B1D36] hover:text-white transition"
                >
                  Book Consultation
                </Link>
              </div>
            ...
            <div>
              <div className="rounded-2xl overflow-hidden shadow-sm border border-[#eee] h-[420px] bg-[#e8e0d5] flex items-center justify-center text-[#888]">
                Google Maps embed placeholder
              </div>
              <p className="text-sm text-[#888] mt-3 text-center">
                Conveniently located in Aventura with easy access from I-95 and local roads.
              </p>
            </div>
          </div>

          {/* Extra note */}
          <div className="mt-16 bg-white rounded-2xl p-8 border border-[#eee] max-w-3xl mx-auto text-center">
            <h3 className="text-xl font-bold text-[#0B1D36] mb-3">A calm, private clinical space</h3>
            <p className="text-[#555] leading-relaxed">
              Our Aventura clinic is designed for comfort and privacy. Whether you are coming from Miami, Fort Lauderdale, or elsewhere in South Florida, we welcome you into a setting focused on safety, partnership, and thoughtful care.
            </p>
          </div>
        </div>
      </section>
